...
public class AddUserForm extends javax.swing.JDialog {
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(cbDocumentType, 0, 144, Short.MAX_VALUE))
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        //Validar si alguno de los campos no fue diligenciado solo los campos txtfield
        if (nombre.isEmpty() || apellido.isEmpty() || documento.isEmpty() || correo.isEmpty()) {
            ...
            this.dispose();
            System.out.print("Nombre: " + nombre + " " + apellido + ", documento:"
                    + indexTipoDocumento + " " + tipoDocumento + " " + documento
                    + ", correo: " + correo);
            String query = "INSERT INTO `empleados`(`nombreEmp`,`apellidos`, `tipoDocumento`,`documento` , `correo`) VALUES ('" + nombre + "', '" + apellido
                    + "', '" + tipoDocumento + "', '" + documento + "', '" + correo + "')";

            try {
                connection = conexion.getConnection();
                st = connection.createStatement();
                //Cuando se crea un empleado, se edita o elimina el tipo de statement
            ...
            //Eliminamos la ventana de creacion usuario
            this.dispose();
        }
